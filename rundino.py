...
def main():
	...
	while run:
		...
		BIRD= win.blit(pygame.transform.scale(bird,(40,25)),(X+x_bird,y_bird))
		if not weapon:
		...
		if X<= - 640:
			...
			x_bird = random.randint(400,500)
			x_item = random.randint(240,250)
			y_item = random.randint(120,220)
